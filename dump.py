...
elem5 = elem.find_elements(By.CLASS_NAME  , "flex")
# print(elem5[2].get_attribute("innerHTML"))
with open("exp8.html", "w", encoding="utf-8") as f:
    te=elem5[-1].get_attribute("innerHTML")
    f.write(te)
